...
const styles = StyleSheet.create({
  ...
  mapCard: { backgroundColor: '#FFF', borderRadius: 24, padding: 20, borderWidth: 1, borderColor: '#F1F5F9' },
  mapPlaceholder: { height: 120, backgroundColor: '#F8FAFC', borderRadius: 16, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  mapText: { fontSize: 14, fontWeight: '900', color: '#CBD5E1', letterSpacing: 2 },
  routeLine: { position: 'absolute', height: 2, width: '80%', backgroundColor: '#E2E8F0', top: '50%' },
  node: { position: 'absolute', width: 10, height: 10, borderRadius: 5, backgroundColor: '#F97316', top: '48%' },
  mapStats: { flexDirection: 'row', marginTop: 16, borderTopWidth: 1, borderTopColor: '#F1F5F9', paddingTop: 16, gap: 24 },
  mapStatItem: { flex: 1 },
  mapStatVal: { fontSize: 16, fontWeight: '900', color: '#1E293B' },
  mapStatLabel: { fontSize: 10, color: '#94A3B8', fontWeight: '700', marginTop: 2 },
